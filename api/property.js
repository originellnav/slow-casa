...
module.exports = async function handler(req, res) {
  ...
  function buildFavourites(favs) {
    ...
    let html = '<div class="prop-favs"><p class="prop-section-label">Local Favourites</p><div class="favs-grid">';
...
<head>
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .hero-location { font-size: 11px; letter-spacing: 0.2em; text-transform: uppercase; color: #888; margin-bottom: 12px; }
    .hero-title { font-family: 'DM Serif Display', Georgia, serif; font-size: 52px; line-height: 1.0; letter-spacing: -0.01em; color: #0f0f0f; margin-bottom: 20px; }
    .hero-desc { font-family: 'TT Norms Pro', 'DM Sans', system-ui, sans-serif; font-size: 15px; font-weight: 300; line-height: 1.75; color: #555; max-width: 340px; margin-bottom: 32px; }
    .hero-meta { font-size: 11px; color: #888; letter-spacing: 0.08em; margin-bottom: 32px; }
    .hero-cta {
      display: inline-block; font-size: 11px; letter-spacing: 0.12em; text-transform: uppercase;
      padding: 15px 40px; border: 0.5px solid #0f0f0f; color: #0f0f0f;
      transition: background 0.2s, color 0.2s;
    }
    .hero-cta:hover { background: #0f0f0f; color: #f9f7f2; }

    .prop-editorial { max-width: 760px; margin: 0 auto; padding: 72px 48px 0; }
    .prop-editorial-title {
      font-family: 'DM Serif Display', Georgia, serif;
      font-size: 36px; font-weight: 400; line-height: 1.15;
      color: #2a2a28; margin-bottom: 32px;
    }
    .prop-intro {
    ...
    .prop-section { max-width: 760px; margin: 0 auto; padding: 64px 48px 0; }
    .prop-section-label {
    ...
    .prop-favs { max-width: 760px; margin: 0 auto; padding: 64px 48px 0; }
